...
class DrawerMenu extends StatelessWidget {
  ...
  Widget _buildHeader() {
    return Container(
      ...
      padding: const EdgeInsets.only(top: 40, left: 16, bottom: 16), // Ajustamos el espacio interno
  ...
  Widget _buildMenuItem(IconData icon,String title, bool isSelected){
    return Padding(
      ...
      child: ListTile(
        ...
        tileColor: isSelected ? MandarinaAppTheme.secondaryColor.withValues(alpha: 0.3) : Colors.transparent,
