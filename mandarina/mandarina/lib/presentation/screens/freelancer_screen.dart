...
class _FreelancerScreenState extends State<FreelancerScreen>
  ...
  void _startTimer() {
    setState(() {
      ...
      _timer = Timer.periodic(const Duration(milliseconds: 30), (timer) {
        setState(
          () {},
        ); // Actualiza la UI para animar el slider y el texto de forma fluida
      });
    });
  }
  ...
  void _onButtonTapDown(TapDownDetails details) {
    ...
    _holdingProgressTimer = Timer.periodic(
            ...
            child: Column(
              ...
              children: [
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              color: MandarinaAppTheme.primaryColor.withValues(
                                alpha: 0.1,
                              ), //const Color(0xFFF4F1DE).withOpacity(0.5),
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: GoogleFonts.quicksand(
                                    fontWeight: FontWeight.w800,
                                    color: MandarinaAppTheme
                                        .primaryOrangeColor, //Color(0xFFE07A5F),
                                  ),
                                ),
                              ],
                            ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors
                        .transparent, //MandarinaAppTheme.blueColor,//const Color(0xFF3D405B),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: MandarinaAppTheme
                    .primaryOrangeColor, //const Color(0xFFE07A5F),
  ...
  SizedBox _cronometer(double sliderValue) {
    return SizedBox(
      height: 280,
      width: 280,
      child: SleekCircularSlider(
        appearance: CircularSliderAppearance(
          ...
          customWidths: CustomSliderWidths(
            trackWidth: 6,
            handlerSize:
                16, // Ocultar el manejador para que actúe de visualizador limpio
            progressBarWidth: 14,
            shadowWidth: 0,
          ),
                ...
                Container(
                  ...
                  child: FaIcon(
                    _isRunning
                        ...
                        : FontAwesomeIcons
                              .hourglass, //Icons.hourglass_top_rounded : Icons.hourglass_empty_rounded,
                    color: Colors.white,
                    size: 32,
                  ),
                ),
